...
```
From the box plot, most of the movies on our dataset have a median rating of 7.5 
...
```{r Popular genres}
plot <- ggplot(data = genres_df)+
  geom_bar(aes(x = name), fill = "dark green", alpha = 0.5)+
  coord_flip()
  
print(plot)
```
Most popluar movie genres are dramas, followed by comedy, thriller and action. The drama genre has more more than tiwce the number of movies in the action genre.
