...
The correlation value of 0.46 suppors our findings from the popularity vs revenue scatter plot. It shows a weak relationship between the two vairables.

```{r which language has the most revenue?}
ggplot(data)+
...
ggplot(data)+
  ...
  xlab("Original language")
```
To our suprise, Norwegian language seems to be the most popular followed by Indonesian and then english. Hebrew comes in at fourth and japanese at fifth. Indian movies, tough they are lengthy, are not liked by everyone.
